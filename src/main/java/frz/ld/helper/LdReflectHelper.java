...
import frz.ld.helper.stringcast.*;
...
public class LdReflectHelper {
	 ...
	 */
	static {
		stringCastTypeMap.put(Boolean.class, new LdStringCastBoolean());
		stringCastTypeMap.put(Long.class, new LdStringCastLong());
		stringCastTypeMap.put(Integer.class, new LdStringCastInteger());
		stringCastTypeMap.put(Float.class, new LdStringCastFloat());
		stringCastTypeMap.put(java.util.Date.class,
				LdStringCastDate.newInstance(LdStringCastDate.defaultDateFormatStr));
	}
	 ...
	 * @param clazz
	 * @return
	 * @throws LdReflectException
	 */
	public static Object newInstance(Class<?> clazz) throws LdReflectException {
		try {
			return clazz.newInstance();
		} catch (InstantiationException e) {
			e.printStackTrace();
			throw new LdReflectException("\nReflectHelper.newInstance：无法实例化" + ".\n");
	 ...
	 *             反射过程异常
	 */
	public static Object instanceConstructor(Constructor<?> constructor, Object... params) throws LdReflectException {
		try {
	 ...
	 *             反射异常
	 */
	public static Object invokeMethod(Object obj, Method method, Object... params) throws LdReflectException {
		try {
	...
	public static Object invokeMethodByName(Object obj, Class<?> clazz, String name, Class<?>[] parameterTypes,
			boolean includeSuper, Object... params) throws LdReflectException {
	 ...
	 *             反射过程异常
	 */
	public static Field findFieldByName(Class<?> clazz, String name, boolean includeSuper) throws LdReflectException {
		try {
	...
	public static Object invokeObjectMethodByName(Object obj, Class<?> clazz, String methodName, String[] paramsName,
			boolean includeSuper, String... values) throws LdReflectException {
	 ...
	 *             反射过程异常
	 */
	public static Object getValue(Object obj, String fieldName, boolean includeSuper) throws LdReflectException {
